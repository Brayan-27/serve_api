...
$data = json_decode(file_get_contents("php://input"),true);
    ...
    $cantidad_max = $data ['cantidad_max'];
        ...
        $sql = "INSERT INTO productov(tipo, nombreali, cantidad_pro, cantidad_min, cantidad_med, cantidad_max) VALUES(:tipo, :nombreali, :cantidad_pro, :cantidad_min, :cantidad_med, :cantidad_max)";

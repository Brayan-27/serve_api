...
$data = json_decode(file_get_contents("php://input"),true);
    ...
    $Gr_ML_Cena = $data ['Gr_ML_Cena'];
        ...
        $sql = "INSERT INTO Pedidos_Diario_Llano(Des_de_alimnentos, Unidad_de_Media, Gr_ML_Desayuno, Gr_ML_Sopa, Gr_ML_Segundo, Gr_ML_Cena) VALUES(:Des_de_alimnentos, :Unidad_de_Media, :Gr_ML_Desayuno, :Gr_ML_Sopa, :Gr_ML_Segundo, :Gr_ML_Cena)";

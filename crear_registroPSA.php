...
$data = json_decode(file_get_contents("php://input"),true);
    ...
    $domingo = $data ['domingo'];
        ...
        $sql = "INSERT INTO pedidos_semanal_altiplano(Des_de_semana, mes, lunes, martes, miercoles, jueves, viernes, sabado, domingo) VALUES(:Des_de_semana, :mes, :lunes, :martes, :miercoles, :jueves, :viernes, :sabado, :domingo)";

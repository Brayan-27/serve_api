...
$data = json_decode(file_get_contents("php://input"),true);
    ...
    $domingo = $data ['domingo'];
        ...
        $sql = "INSERT INTO tb_semanalv(numsemana, descripcion, lunes, martes, miercoles, jueves, viernes, sabado, domingo) VALUES(:numsemana, :descripcion, :lunes, :martes, :miercoles, :jueves, :viernes, :sabado, :domingo)";
